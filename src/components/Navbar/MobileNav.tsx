        ...
        <section className="w-full fixed bottom-0 left-0 z-50 bg-zinc-800">
            <ul className="py-2 flex justify-around">
                <li>
                    ...
                    <label className="cursor-pointer" htmlFor="mnav-home" onClick={() => navigate('/')} >
                ...
                <li>
                    ...
                    <label className="cursor-pointer" htmlFor="mnav-filmes" onClick={() => navigate('/filmes')} >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} 
                        className="w-10 h-10" stroke="currentColor">
                ...
                <li>
                    ...
                    <label className="cursor-pointer" htmlFor="mnav-series" onClick={() => navigate('/series')} >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} 
                        className="w-10 h-10" stroke="currentColor">
