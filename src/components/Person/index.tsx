...
const Person: React.FC<{person?: ICastPerson}> = function( {person} ) { 
    ...
    return (
        <div className="flex gap-3 items-center w-1/2 py-4">
            <div className={`w-24 rounded-full bg-center bg-contain bg-no-repeat ${animate} ${background}`} style={ {height: '122px', backgroundImage: `url(https://www.themoviedb.org/t/p/w138_and_h175_face${person?.profile_path})`} } />
